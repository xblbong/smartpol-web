...
const ChatHistoryLegislator = ({ onSelectSession, onNewChat, currentSessionId }) => {
    ...
    <div className="p-4">
     <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <FaHistory className="text-[#1d8686]" />
          <Title level={5} className="mb-0" style={{ color: '#28B8B8' }}>
            Riwayat Chat
          </Title>
        </div>
        <Tooltip title="Chat Baru" placement="bottom">
          <Button
            ...
            style={{ backgroundColor: '#28B8B8', borderColor: '#28B8B8' }}
          />
        </Tooltip>
      </div>
...
export default ChatHistoryLegislator;