...
const PromptInputLegislator = ({ onSendMessage, isTyping }) => {
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-0">
        {isTyping && (
          <div className="flex items-center gap-2 mb-3 text-gray-500 text-sm animate-fade-in">
            <div className="flex gap-1">
              <div className="w-2 h-2 rounded-full animate-bounce" style={{backgroundColor: '#28b8b8'}}></div>
              <div className="w-2 h-2 rounded-full animate-bounce" style={{backgroundColor: '#28b8b8', animationDelay: '0.1s'}}></div>
              <div className="w-2 h-2 rounded-full animate-bounce" style={{backgroundColor: '#28b8b8', animationDelay: '0.2s'}}></div>
            </div>
        ...
        >
          ...
          <button
            ...
            style={{backgroundColor: '#28b8b8', focusRingColor: '#28b8b8'}}
            title="Kirim Pesan"
          >
...
export default PromptInputLegislator;